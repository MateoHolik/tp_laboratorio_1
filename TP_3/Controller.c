					...
					do
					{
						...
						switch (opcionMenu)
						{
							...
							/*case 5: //codigo de vuelo
								inputString(auxPassengerModificado->codigoVuelo,"Ingrese el Codigo de Vuelo","Error, Ingrese el Codigo de Vuelo", 1, PASSENGER_MAX_NOMBRE, 54);
								Passenger_setCodigoVuelo(auxPassengerModificado, auxPassengerModificado -> codigoVuelo);
