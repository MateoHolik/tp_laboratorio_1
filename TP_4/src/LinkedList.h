...
/** \brief Permite realizar el test de la funcion addNode la cual es privada CORREGIR ESTA DOCU
 *
 * \param this LinkedList* Puntero a la lista
 ...
 * EN QUE INDICE DE LOS NODOS ESTA EL ELEMENTO
 * \param this LinkedList* Puntero a la lista
 ...
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio //dice si tenes que swapear o no
 * \param order int  [1] Indica orden ascendente - [0] Indica orden descendente
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */

int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order); Node* getNode(LinkedList* this, int nodeIndex);
